...
//            ((TopBannerViewHolder) holder).bindingData((ProductDetailTopVM) detailModel);
...
//            ((QAViewHolder) holder).bindingData((PdpQAVM) detailModel);
...
//            ((ReviewsViewHolder) holder).bindingData((PdpReviewsVM) detailModel);
...
//            viewPager.setAdapter(new PdpBannerAdapter(itemView.getContext(), bannerVM.getBannerUrls()));
...
//        }
//
//        void bindingData(PdpQAVM qaContentVM) {
...
//        }
//
//        void bindingData(PdpReviewsVM reviewsContentVM) {
