...
public class PendingPresenter extends RxPresenter<PendingContract.View> implements
    PendingContract.Presenter {

    private AccountRepository accountRepository;

    public PendingPresenter(AccountRepository accountRepository) {
        this.accountRepository = accountRepository;
    }

    @Override
    public void pendingRequest(Map<String, Object> params) {
        mView.showLoadingBar();
        addSubscrebe(accountRepository.pendingRequest(params).subscribeWith(
            new DisposableObserver<MyRewardsResponse>() {
                ...
                public void onError(Throwable e) {
                    mView.hideLoadingBar();
                    mView.showPendingResult(getMockDatas());
                }
