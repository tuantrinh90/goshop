...
public class MyOrderPresenter extends RxPresenter<MyOrderContract.View> implements MyOrderContract.Presenter{
    ...
    public void getOrderList(Map<String, Object> params) {
        ...
        addSubscrebe(accountRepository.myOrderListRequest(params).subscribeWith(new DisposableObserver<MyOrderListResponse>(){
    ...
    public void getOrderDetail(Map<String, Object> params) {
        ...
        addSubscrebe(accountRepository.myOrderDetailRequest(params).subscribeWith(new DisposableObserver<MyOrderDetailReponse>(){
