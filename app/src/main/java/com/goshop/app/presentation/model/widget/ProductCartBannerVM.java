...
public class ProductCartBannerVM extends ShoppingCartModel {

    private List<CarouselItemsVM> carouselItemsVMS;

    public ProductCartBannerVM(List<CarouselItemsVM> carouselItemsVMS) {
        super(ShoppingCartModel.CART_BANNER);
