...
public class CustomMPEditText extends RelativeLayout {
    ...
    public CustomMPEditText(Context context) {
        super(context);
    ...
    private void initView(Context context, AttributeSet attrs) {
        View editView = LayoutInflater.from(context)
            .inflate(R.layout.layout_edittext_mp, this, true);
    ...
    public CustomMPEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public CustomMPEditText(Context context, AttributeSet attrs, int defStyleAttr) {
