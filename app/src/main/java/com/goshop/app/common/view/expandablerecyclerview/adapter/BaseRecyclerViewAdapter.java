package com.goshop.app.common.view.expandablerecyclerview.adapter;

import com.goshop.app.common.view.expandablerecyclerview.bean.BaseItem;
...
import static com.goshop.app.common.view.expandablerecyclerview.holder.BaseViewHolder
    .VIEW_TYPE_CHILD;
import static com.goshop.app.common.view.expandablerecyclerview.holder.BaseViewHolder
    .VIEW_TYPE_PARENT;

@SuppressWarnings("ALL")
public abstract class BaseRecyclerViewAdapter<T, S, VH extends BaseViewHolder> extends
     ...
     */
    public abstract void onBindChildHolder(VH holder, int groupPos, int childPos, int position,
        S childData);
    ...
    /**
     * Add delete to the original data and call this method to notify.
     */
