...
import com.goshop.app.App;
import com.goshop.app.Const;
import com.goshop.app.R;
import com.goshop.app.model.MultipleItem;
...
public class ServiceData {
    ...
    public static List<MultipleItem> getContentVideoData(){
        String productName=App.getInstance().getResources().getString(R.string.home_item_test_product_name);
        String productPrice=App.getInstance().getResources().getString(R.string.home_item_test_product_price);
